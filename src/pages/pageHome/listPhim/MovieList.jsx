      ...
      <Container className="MovieList container pb-10 pt-5 overflow-hidden">
        ...
        <div className="m-auto text-center">
          ...
          <button
            ...
            className={`text-lg transition duration-300 font-semibold p-2 rounded-lg shadow bg-white hover:bg-white-500 ${
        ...
        <Slider {...settings} className="-mx-5">
          {[...listPhim]
            ...
            .filter(
              (phim) =>
                phim.dangChieu.toString() === search.get("phimdangchieu")
            )
            .map((phim, i) => (
              <div key={i}>
                <div className="p-5">
