        ...
        <Tabs
          ...
          items={lichChieuHeThongRap.map((heThongRap, i) => {
            return {
              key: i,
              label: (
                <img src={heThongRap.logo} alt="" className="w-20 border" />
              ),
              children: (
                <Tabs
                  tabPosition={position}
                    ...
                    return {
                      ...
                      label: (
                        <div className="w-40">
                          ...
                          <p className="whitespace-normal m-0 text-left text-white">
                            {cumRap.diaChi}
                          </p>
                        </div>
                      ),
                          ...
                          {cumRap.danhSachPhim.map((phim, i) => (
                            <div key={i} className="border-b py-3 sm:flex">
                              ...
                              <div className="sm:pl-5 flex-1">
                                <h1 className="ml-6 text-2xl text-white font-medium">
                                  {phim.tenPhim}
                                </h1>
